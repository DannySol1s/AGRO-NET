...
export default function ProductoDetalle() {
  ...
  const { cantidadBaseKg } = useSeleccionStore();
  ...
  // ScaleAdjuster — pre-llena con los kg disponibles de la materia prima actual
  const [escalaAbierta, setEscalaAbierta] = useState(false);
  const [cantidadDeseada, setCantidadDeseada] = useState(cantidadBaseKg);
